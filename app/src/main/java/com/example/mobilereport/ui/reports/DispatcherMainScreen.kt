...
@Composable
fun DispatcherMainScreen(navController: NavController) {
    ...
    Scaffold(
        ...
        Column(
            ...
            Button(onClick = {
                ...
                picker.show(activity.supportFragmentManager, "dispatcher_range_picker")
            }) {
            ...
            dateRange?.let { (start, end) ->
                ...
                Button(
                    onClick = {
                        navController.navigate("dispatcherDetail/$start/$end")
                    },
                    modifier = Modifier.fillMaxWidth()
                ) {
                    Text("View Dispatcher Summary")
                }
            }
        }
    }
